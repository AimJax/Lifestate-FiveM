...
$jsxAuditFiles = @(
  ...
  'apps/phone/src/ui/components/LsOneHeader.tsx',
  ...
  'apps/phone/src/apps/contacts/components/views/ContactsPage.tsx',
  'apps/phone/src/apps/contacts/components/List/ContactList.tsx',
  'apps/phone/src/apps/contacts/components/List/SearchContacts.tsx',
